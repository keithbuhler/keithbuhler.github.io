...
Simple apprehension, plus induction is used to form basic propositions, such as that balls are round, grass is green, the sky is blue, Mom is kind, Fido is soft. 

</section><section data-markdown>

Abduction is guessing or explaining. Perhaps the whole earth is round (it is). Maybe your mom is kind, too (she is). Perhaps all grass is green (it's not). Maybe all dogs are soft (they're not). 
...
1. Fallacies of Oversimplification
2. Fallacies of Argumentation
3. Procedural Fallacies
